    ...
    <div className="py-16 bg-primary-dark">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {cars.map((car) => (
            <div key={car.id} className="bg-primary-dark-soft rounded-lg overflow-hidden shadow-lg transform hover:scale-105 transition-transform duration-300 flex flex-col">
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="flex space-x-4 mt-auto">
                  <Link href={`/buy/${car.id}`} className="bg-accent-silver hover:bg-opacity-80 text-primary-dark font-bold py-2 px-4 rounded w-full text-center transition-colors">
                    Info
                  </Link>
